...
#
ff1 <-filter(pstat,region=="AF",subregion==1,!is.na(delta_year_patch))
acf(ff1$prop_max_patch)

(sf <-summary(rq(abs(delta_year_patch)~year,data=ff1,tau=c(.25)),se="boot",R=999))
#coef(sf)[2,]
