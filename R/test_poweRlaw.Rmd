...
ms <- bootstrap_p(m,no_of_sims = 10, xmax = max(testP), threads = 2, xmins=est$xmin)
ms

# Estimate parameter uncertainty
#
ms <- bootstrap(m,no_of_sims = 10, xmax = max(testP), threads = 2, xmins=(est$xmin-10):(est$xmin+10))
sd(ms$bootstraps[,1])
sd(ms$bootstraps[,2])
