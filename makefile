...
all: Appendices.pdf CriticalGF.pdf GraphicalAbstract.pdf CriticalGF_bioRxiv.pdf
...
CriticalGF_bioRxiv.pdf: CriticalGF_bioRxiv.md nolineno.sty CriticalGF.bib
	cp "/home/leonardo/BibTeX/Manuscritos-Critical global forest.bib" CriticalGF.bib
