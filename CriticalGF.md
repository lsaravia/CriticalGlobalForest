...
There are several processes that can convert a catastrophic transition to a second order transitions [@Martin2015]. These include stochasticity, such as demographic fluctuations, spatial heterogeneities, and/or dispersal limitation. All these components are present in forest around the globe [@Filotas2014;@Fung2016;@Seidler2006], and thus continuous transitions might be more probable than catastrophic transitions. Moreover there is some evidence of recovery in some systems that supposedly suffered an irreversible transition produced by overgrazing [@Zhang2005] and desertification [@Allington2010]. 
