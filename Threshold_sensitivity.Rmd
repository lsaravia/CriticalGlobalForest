...
#
plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(30,40)), "AF1")      # Increasing at 30
plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(20,30,40)), "EUAS1") # Increasing at 30 40, decreasing at 20 
plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(35,40)), "EUAS2")    # Increasing at 35 40
plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(20,25,30)), "NA1")   # Decreasing all

plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(25,30,35)), "OC1")   # Increasing 30 35
plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(25,30,35)), "OC2")   # Decreasing 25 30 35
plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(35,40)), "OC3")      # Increasing 40
plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(20,25,30)), "OC4")   # Increasing 30 35
plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(40)), "OC6")         # Increasing 40
plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(25,30)), "SAST1")    # Increasing 25 30
plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(20,25,30,40)), "SAST2")    # Increasing 25 40
plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(25,30,35)), "SAT1")     # Decreasing 25 30 35
plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(20,25)), "SEAS1")       # Increasing 25

plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(20,25,30,35,40)), "SEAS2") # Increasing 30 40 Decreasing 20 25
