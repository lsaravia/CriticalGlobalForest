...
#
plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(20,25,30,35,40)), "AF1")
plot_RSmax_Fluctuations_yearThreshold(pstat_threshold, "SEAS2")
plot_RSmax_Fluctuations_yearThreshold(pstat_threshold, "SAST1")
plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(20,25,30,35,40)), "EUAS1")
...
fft <- fit_delta_threshold %>% filter(pvalue<0.05) %>% arrange(regsub) %>% select(regsub,threshold,model_name:n,LRT,pvalue,AICc_weight,group)
