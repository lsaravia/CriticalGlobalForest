...
plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(20,25,30,35,40)), "AF2",c(20))      # Increasing at 20
...
plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(20,25,30,35,40)), "EUAS2",c(35,40))    # Increasing at 35 40
...
plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(20,25,30,35,40)), "OC1", c(30,35) )   # Increasing 30 35
ggsave("figure/DeltaRSmax_yearThreshold_OC1.png",width=6,height=6,units="in",dpi=600)

plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(20,25,30,35,40)), "OC2", c(25,30,35))   # Decreasing 25 30 35
ggsave("figure/DeltaRSmax_yearThreshold_OC2.png",width=6,height=6,units="in",dpi=600)

plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(20,25,30,35,40)), "OC3",c(35,40))      # Increasing 40
ggsave("figure/DeltaRSmax_yearThreshold_OC3.png",width=6,height=6,units="in",dpi=600)

plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(20,25,30,35,40)), "OC4",c(20,25,30))   # Increasing 30 35
ggsave("figure/DeltaRSmax_yearThreshold_OC4.png",width=6,height=6,units="in",dpi=600)

plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(20,25,30,35,40)), "OC6",c(40))         # Increasing 40
...
plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(20,25,30,35,40)), "SAST2",c(20,25,30,40))    # Increasing 25 40
ggsave("figure/DeltaRSmax_yearThreshold_SAST2.png",width=6,height=6,units="in",dpi=600)

plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(20,25,30,35,40)), "SAT1",c(25,30,35))     # Decreasing 25 30 35
...
plot_RSmax_Fluctuations_yearThreshold(filter(pstat_threshold, threshold %in% c(20,25,30,35,40)), "SEAS2",c(20,25,30,40)) # Increasing 30 40 Decreasing 20 25
...
ff <- add_row(ff,regsub="SEAS1",threshold=c(20,25))
